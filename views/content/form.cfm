                    ...
                    <cfform action="#application.baseURL#?page=content-save" method="post" id="contentForm">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <cfinput type="text" class="form-control" id="title" name="title" >
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <cfselect name="category" class="form-select" >
                                    ...
                                    <cfloop query="variables.categories">
                                        <option value="#variables.categories.category_id#">#variables.categories.name#</option>
                                    </cfloop>
                                </cfselect>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <cfselect name="tags" class="form-select" multiple="true">
                                    <cfloop query="variables.tags">
                                        <option value="#variables.tags.tag_id#">#variables.tags.slug#</option>
                                    </cfloop>
                                </cfselect>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <cftextarea class="form-control" id="content" name="content" style="height: 120px;"></cftextarea>
                        </div>
